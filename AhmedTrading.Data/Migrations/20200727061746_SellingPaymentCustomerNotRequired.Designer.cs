...
namespace AhmedTrading.Data.Migrations
{
    ...
    [Migration("20200727061746_SellingPaymentCustomerNotRequired")]
    partial class SellingPaymentCustomerNotRequired
    {
            ...
            modelBuilder.Entity("AhmedTrading.Data.Vendor", b =>
                {
                    ...
                    b.Property<double>("Balance")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("float")
                        .HasComputedColumnSql("(((([Paid]+[Advance])+[Commission])+[TotalDiscount])-([TotalAmount]+[ReturnAmount]))");
